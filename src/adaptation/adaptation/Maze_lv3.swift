...
class MazeLV3 : Maze{
    ...
    override init(m: Int, n: Int, scene: SKScene) {
        ...
        [[nil, nil, nil, nil, nil, nil, nil, nil, nil                                                           ], // Walls
         [nil,  SKSpriteNode(), nil,nil, endSpriteNode,  SKSpriteNode(), nil,  SKSpriteNode(), nil                                    ],
         [nil, nil, nil,nil,  SKSpriteNode(), nil, nil,  SKSpriteNode(), nil               ],
         [nil, nil,  SKSpriteNode(),  SKSpriteNode(), nil, nil, nil, nil, nil                                     ],
         [nil, nil, nil, SKSpriteNode(), nil, nil,  SKSpriteNode(),  SKSpriteNode(), nil                          ],
         [nil, nil, nil,  SKSpriteNode(), nil,  SKSpriteNode(), nil, nil, nil                          ],
         [nil, nil,  SKSpriteNode(), nil, startSpriteNode,  SKSpriteNode(), nil, nil, nil                           ],
         [nil, nil, nil, SKSpriteNode(), nil, nil, nil,  SKSpriteNode(), nil               ],
         [nil, nil,  SKSpriteNode(), nil, nil,  SKSpriteNode(), nil, nil, nil                                     ],
         [nil, nil,  SKSpriteNode(), nil, nil,  SKSpriteNode(), nil,  SKSpriteNode(), nil                          ],
         [nil, nil, nil, SKSpriteNode(), nil, nil, nil, nil, nil                          ],
         [nil,  SKSpriteNode(), nil, nil, nil,  SKSpriteNode(), nil, nil, nil                                                           ],
         [nil, SKSpriteNode(),  SKSpriteNode(),  SKSpriteNode(), nil,  nil, nil,  SKSpriteNode(), nil    ],
